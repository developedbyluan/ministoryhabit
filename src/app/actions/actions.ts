...
export async function createReply(postId: number, text: string, videoUrl: string) {
  await supabase.from("replies").insert({ post_id: postId, content: text, video_url: videoUrl });
}
